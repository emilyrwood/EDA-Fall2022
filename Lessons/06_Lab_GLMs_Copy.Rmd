...
PM2.5byOzine.regression <- lm(data = EPAair, PM2.5 ~ Ozone)
summary(PM2.5byOzine.regression)
...
PM2.5byOzone.Plot <- 
  ...
  geom_text()# how to add the regression equation to the scatter plot?
...
OzonebyALL.regression <- lm(data = EPAair.subset, PM2.5 ~ Ozone +Year + Month + meanLng + meanLat)
...
OzoneBest.regression <- lm(data = EPAair.subset, PM2.5 ~ Ozone + Month + meanLng + meanLat)

step(OzoneBest.regression)
