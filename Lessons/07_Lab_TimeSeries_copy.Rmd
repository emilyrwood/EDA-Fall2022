...
Temperature_ts <- ts(Temp_BR_processed$Temperature_C, 
...
Temperature_ts_Decomposed <- stl(Temperature_ts, s.window = "periodic")

plot(Temperature_ts_Decomposed)
...
Tempurature_Components <- as.data.frame(Temperature_ts_Decomposed$time.series[,1:3])
